...
public class TopTabView extends BaseView<String[]> {
	...
	public TextView tvTopTabViewTabSecond;
	public TextView tvTopTabViewTabThrid;
	...
	public View createView() {
		...
		tvTopTabViewTabSecond = findView(R.id.tvTopTabViewTabSecond);
		tvTopTabViewTabThrid = findView(R.id.tvTopTabViewTabThird);
	...
	public void bindView(String[] names){
		...
		tvTabs[1] = tvTopTabViewTabSecond;
		tvTabs[2] = tvTopTabViewTabThrid;
	...
	public void select(int position) {
		...
		if(position==0){
			findView(R.id.leftline).setVisibility(View.VISIBLE);
			findView(R.id.twoline).setVisibility(View.INVISIBLE);
			findView(R.id.threeline).setVisibility(View.INVISIBLE);
			findView(R.id.rightline).setVisibility(View.INVISIBLE);
		}else if(position==1){
			findView(R.id.leftline).setVisibility(View.INVISIBLE);
			findView(R.id.twoline).setVisibility(View.VISIBLE);
			findView(R.id.threeline).setVisibility(View.INVISIBLE);
			findView(R.id.rightline).setVisibility(View.INVISIBLE);
		}else if(position==2){
			findView(R.id.leftline).setVisibility(View.INVISIBLE);
			findView(R.id.twoline).setVisibility(View.INVISIBLE);
			findView(R.id.threeline).setVisibility(View.VISIBLE);
			findView(R.id.rightline).setVisibility(View.INVISIBLE);
		}else{
			findView(R.id.leftline).setVisibility(View.INVISIBLE);
			findView(R.id.twoline).setVisibility(View.INVISIBLE);
			findView(R.id.threeline).setVisibility(View.INVISIBLE);
			findView(R.id.rightline).setVisibility(View.VISIBLE);
		}
	}
