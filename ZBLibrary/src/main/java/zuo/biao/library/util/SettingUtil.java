...
public final class SettingUtil {
	 ...
	 *  改为你的正式服务器地址
	 */
	public static final String URL_SERVER_ADDRESS_NORMAL_HTTP = "http://doctor.nat100.top";//正式服务器
	/**
	 *  改为你的正式服务器地址
	 */
	public static final String URL_SERVER_ADDRESS_NORMAL_HTTPS = "https://doctor.nat100.top";//正式服务器
	/**
	 *  改为你的测试服务器地址,如果有的话
	 */
	public static final String URL_SERVER_ADDRESS_TEST = "https://doctor.nat100.top";//测试服务器
