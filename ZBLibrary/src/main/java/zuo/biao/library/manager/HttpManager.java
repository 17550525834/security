...
//			socketFactory = SSLUtil.getSSLSocketFactory(context.getAssets().open("demo.cer"));
    ...
    public void postSpecial(final Map<String, Object> request, final String url
            , final int requestCode, final OnHttpResponseListener listener) {
        post(request, url, true, requestCode, listener);
    }

    public void postRaw(String json,String url,int requestCode,OnHttpResponseListener listener) {
        new AsyncTask<Void, Void, Exception>() {
            String content = null;
...
//                Toast.makeText(context, "content is "+content, Toast.LENGTH_SHORT).show();;
                return null;
            }
            ...
            protected void onPostExecute(Exception e) {
                ...
                listener.onHttpResponse(requestCode,content,e);
    ...
    public void postImg(int userid, String url, List<String> imagePath, int requestcode, OnHttpResponseListener listener) throws IOException, JSONException {
        new AsyncTask<Void, Void, String>() {
                    ...
                    for (String path : imagePath) {
                        ...
                        if (file != null && file.exists()) {
                            if (path.contains("jpg"))
                                builder.addFormDataPart("files", file.getName(), RequestBody.create(MediaType.parse("application/x-jpg"), file));//"image/jpg"
                            else
                                builder.addFormDataPart("files", file.getName(), RequestBody.create(MediaType.parse("application/octet-stream"), file));//"image/jpg"
                        }
            ...
            protected void onPostExecute(String s) {
                ...
                Log.e(TAG, s);
                listener.onHttpResponse(requestcode, s, null);
            }
        }.execute();
    ...
    public void postFiles(String userid, String url, List<String> imagePath, int requestcode, OnHttpResponseListener listener) throws IOException, JSONException {
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                ...
                RequestBody bodyParams = RequestBody.create(MutilPart_Form_Data, JSON.toJSONString(imagePath));
...
//		}
    ...
    public String getCookie(String host) {
        ...
        Log.e(TAG, "getCookie  host == " + host + " value = " + context.getSharedPreferences(KEY_COOKIE, Context.MODE_PRIVATE).getString(host, ""));
    ...
    public void saveCookie(String host, String value) {
        ...
        Log.e(TAG, "saveCookie  host == " + host + " value " + value);
